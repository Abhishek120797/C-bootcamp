...
void makeMatrix();    // make matrix
void displayMatrix(); // display matrix
int checkWin();       // check winning situation
void rightSift(int, int);
void leftShift(int, int);
void upshift(int, int);
void downshift(int, int);
